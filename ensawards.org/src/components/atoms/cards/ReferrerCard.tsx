...
interface ReferrerIdentityProps {
    address: Address;
}

const ReferrerIdentity = ({address}: ReferrerIdentityProps) => {
    return <p className="text-sm">{truncateAddress(address)}</p>
};

const ReferrerIdentityLoading = () => <div className="animate-pulse bg-gray-300 rounded-sm w-[100px] h-4" />
        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <ReferrerIdentity address={referrerData.referrer}/>
                </div>
            </div>
            {/*Mobile Header*/}
            <div
