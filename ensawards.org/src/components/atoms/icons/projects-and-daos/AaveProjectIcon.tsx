...
export const AaveProjectIcon = (props: React.SVGProps<SVGSVGElement>) => <svg width="266" height="139" viewBox="0 0 266 139" fill="none"
                                          xmlns="http://www.w3.org/2000/svg" style={{padding: "4px"}} {...props}>
    <path
        ...
        fill="#9896FF" style={{fill:"#9896FF",fillOpacity:"1"}}/>
    <path
