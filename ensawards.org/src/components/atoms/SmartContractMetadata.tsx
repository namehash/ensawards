...
import { BookOpen, Braces, ShieldCheck, CircleUser } from "lucide-react";
          ...
          content={
              <div className="w-full max-w-[275px] flex flex-col gap-1 justify-start items-start">
                  <div className="self-stretch flex flex-row flex-nowrap justify-between items-center">
                      ...
                      <span className={cn("text-xs rounded-full py-1 px-2", metadata && metadata.docs ? "text-emerald-100 bg-emerald-600" : "text-red-100 bg-red-600")}>{metadata && metadata.docs ? "Set" : "Not set"}</span>
                  </div>
        ...
        >
              ...
              content={
                  <div className="w-full max-w-[275px] flex flex-col gap-1 justify-start items-start">
                      <div className="self-stretch flex flex-row flex-nowrap justify-between items-center">
                          ...
                          <span
                              className={cn("text-xs rounded-full py-1 px-2", metadata && metadata.compiledMetadata ? "text-emerald-100 bg-emerald-600" : "text-red-100 bg-red-600")}>{metadata && metadata.compiledMetadata ? "Set" : "Not set"}</span>
                      </div>
                      <span className="w-full h-[1px] self-stretch bg-white"/>
          ...
          >
              <Braces
                  className={cn(
                      "w-[20px] h-[20px] cursor-pointer",
                      metadata && metadata.compiledMetadata ? "text-black" : "text-gray-300 hover:text-gray-500",
                  )}
              />
          </GenericTooltip>
          <GenericTooltip
              content={
                  <div className="w-full max-w-[275px] flex flex-col gap-1 justify-start items-start">
                      <div className="self-stretch flex flex-row flex-nowrap justify-between items-center">
                          ...
                          <span
                              className={cn("text-xs rounded-full py-1 px-2", metadata && metadata.avatar ? "text-emerald-100 bg-emerald-600" : "text-red-100 bg-red-600")}>{metadata && metadata.avatar ? "Set" : "Not set"}</span>
                      </div>
                      <span className="w-full h-[1px] self-stretch bg-white"/>
              ...
              content={
                  <div className="w-full max-w-[275px] flex flex-col gap-1 justify-start items-start">
                      <div className="self-stretch flex flex-row flex-nowrap justify-between items-center">
                          ...
                          <span
                              className={cn("text-xs rounded-full py-1 px-2", metadata && metadata.audits ? "text-emerald-100 bg-emerald-600" : "text-red-100 bg-red-600")}>{metadata && metadata.audits ? "Set" : "Not set"}</span>
                      </div>
                      <span className="w-full h-[1px] self-stretch bg-white"/>
