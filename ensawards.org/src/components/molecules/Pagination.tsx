...
export function Pagination({
  ...
  return (
    <div className="w-fit h-fit flex flex-row flex-nowrap justify-center items-center gap-1 text-black">
      ...
      <button aria-disabled={currentPage === 1} className={cn(buttonStyles)} onClick={onPrevious}>
        <ChevronLeft size={16} />
      ...
      <div className="hidden sm:flex flex-row flex-nowrap justify-center items-center gap-1">
        <button
          className={cn(buttonStyles, currentPage == 1 && "border border-gray-200")}
          onClick={() => {
            onChosen(1);
          }}
        >
        ...
        <Ellipsis
          className={cn(currentPage < numberOfPages - 2 && numberOfPages > 2 ? "block" : "hidden")}
          size={16}
        />
        <button
          className={cn(buttonStyles, currentPage == numberOfPages && "border border-gray-200")}
          onClick={() => {
