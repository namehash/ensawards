...
import {type AppData, APPS} from "@/data/appData.ts";
import {type BestPractice, BEST_PRACTICE_CATEGORIES, type BestPracticeCategory} from "@/data/bestPracticesData.ts";
