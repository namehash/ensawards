...
/**
 * The minimal value of {@link totalReferralsContribution} that the referrer needs to be qualified for the
 * ENS holiday referral awards program's rewards.
 */
export const REFERRER_PROGRAM_QUALIFICATION_THRESHOLD = 0.05;
