...
const contracts: Contract[] = [
  {
    ...
    cachedIdentity: {
      ...
      contract: {
        address: asNormalizedAddress("0xc18360217d8f7ab5e7c516566761ea12ce7f9d72"),
        chain: mainnet,
        codeName: "ENSToken",
      },
  ...
  },
  {
    ...
    cachedIdentity: {
      ...
      contract: {
        address: asNormalizedAddress("0xd7a029db2585553978190db5e85ec724aa4df23f"),
        chain: mainnet,
        codeName: "TokenLock",
      },
  ...
  },
  {
    ...
    cachedIdentity: {
      resolutionStatus: ContractResolutionStatusIds.ForwardNamed,
      contract: {
        address: asNormalizedAddress("0x323a76393544d5ecca80cd6ef2a560c6a395b7e3"),
        chain: mainnet,
  ...
  },
  {
    ...
    cachedIdentity: {
      resolutionStatus: ContractResolutionStatusIds.PrimaryNamed,
      contract: {
        address: asNormalizedAddress("0xfe89cc7abb2c4183683ab71653c4cdc9b02d44b7"),
        chain: mainnet,
  ...
  },
  {
    ...
    cachedIdentity: {
      resolutionStatus: ContractResolutionStatusIds.PrimaryNamed,
      contract: {
        address: asNormalizedAddress("0x02d61347e5c6ea5604f3f814c5b5498421cebdeb"),
        chain: mainnet,
        codeName: "SafeProxy",
      },
  ...
  },
  {
    ...
    cachedIdentity: {
      resolutionStatus: ContractResolutionStatusIds.PrimaryNamed,
      contract: {
        address: asNormalizedAddress("0x552df471a4c7fea11ea8d7a7b0acc6989b902a95"),
        chain: mainnet,
        codeName: "Veto",
      },
  ...
  },
  {
    ...
    cachedIdentity: {
      resolutionStatus: ContractResolutionStatusIds.PrimaryNamed,
      contract: {
        address: asNormalizedAddress("0x4f2083f5fbede34c2714affb3105539775f7fe64"),
        chain: mainnet,
