...
const bulkDistribution1TransactionHash =
  "0x97b1011ebe8253cc54876d79390b8927cfb72d0307b5c32009035f0fb656ff8f";

const bulkDistribution1Timestamp = parseTimestamp("2026-03-06T11:21:23Z");
...
const ensContractNamingSeasonAwards: Award[] = [
  {
    ...
    award: 500,
    awardedAt: bulkDistribution1Timestamp,
    chainId: mainnet.id,
    transactionHash: bulkDistribution1TransactionHash,
  },
  {
    type: AwardTypes.FinancialAward,
...
defineAwards(EnsContractNamingSeason, ensContractNamingSeasonAwards);
