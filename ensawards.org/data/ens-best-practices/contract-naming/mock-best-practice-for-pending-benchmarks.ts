...
const mockBestPracticeForPendingBenchmarks: BestPracticeApp = {
  type: BestPracticeTypes.App,
  id: "mock-best-practice-for-pending-benchmarks",
  bestPracticeSlug: "mock-best-practice-for-pending-benchmarks",
  name: "Mock Best Practice For Pending Benchmarks",
  description: "Test new logic for pending benchmarks.",
...
defineBestPractice(mockBestPracticeForPendingBenchmarks);

export default mockBestPracticeForPendingBenchmarks;
