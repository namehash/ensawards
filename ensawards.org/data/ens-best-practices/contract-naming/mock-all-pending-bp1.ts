...
const mockAllPendingBP1: BestPracticeApp = {
  type: BestPracticeTypes.App,
  id: "mock-all-pending-bp1",
  bestPracticeSlug: "mock-all-pending-bp1",
  name: "Mock best practice existing category",
  description:
    "Mock best practice description. This is a placeholder for a best practice that belongs to an existing category.",
...
defineBestPractice(mockAllPendingBP1);

export default mockAllPendingBP1;
