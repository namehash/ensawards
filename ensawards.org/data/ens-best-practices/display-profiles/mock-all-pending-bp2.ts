...
import DisplayProfilesCategory from ".";
...
const mockAllPendingBP2: BestPracticeApp = {
  type: BestPracticeTypes.App,
  id: "mock-all-pending-bp2",
  bestPracticeSlug: "mock-all-pending-bp2",
  name: "Mock Best Practice New Category",
  description:
    "Mock best practice description. This is a placeholder for a best practice that belongs to a new category.",
...
defineBestPractice(mockAllPendingBP2);

export default mockAllPendingBP2;
