...
const depositAddresses = {
  "at01-resolve-onchain-name": {
    ...
    contributions: [
      { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-07-01T09:35:08Z") },
    ],
    notes: buildEnsNotSupportedNote({
      method: 'the "withdrawal" flow',
      proof: {
        image: at1Proof,
        alt: "WEEX Exchange doesn't allow ENS names as the recipient in the withdrawal flow",
      },
    }),
  },
