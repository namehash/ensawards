...
import FrameWallet from "data/apps/frame-wallet";
...
const benchmarks: BestPracticeBenchmarks = {
  ...
  "ensv2-ready-resolution": {
    "correctly-resolve-ensv2-test-name-address": {
      ...
      contributions: [
        { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-12T11:46:19Z") },
      ],
      notes: (
        <div className={cn(acceptanceTestDetailsContainerStyles, "w-full")}>
          ...
          <img
            alt="Frame fails to resolve the name for ENSv2"
