...
const depositAddresses = {
  "at01-resolve-onchain-name": {
    ...
    contributions: [
      { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-29T11:08:25Z") },
    ],
    notes: buildEnsNotSupportedNote({
      method: 'the "withdraw" flow',
      proof: {
        image: at1Proof,
        alt: "Bitget Exchange doesn't allow ENS names as the recipient in the withdraw flow",
      },
    }),
  },
