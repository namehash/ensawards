...
const benchmarks: AppBenchmarkCompleted[] = [
  ...
  //   contributions: [
  //   { from: contributors.stevedylan, updatedAt: parseTimestamp("2025-12-03T14:00:00Z") },
  // ],
  // },
  {
    ...
    contributions: [
      { from: contributors.stevedylan, updatedAt: parseTimestamp("2025-12-08T18:28:32.410Z") },
    ],
  },
  {
