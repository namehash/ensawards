...
const method = "the 'withdraw' feature on binance.com";

const depositAddresses = {
  "at01-resolve-onchain-name": {
    result: BenchmarkResults.Fail,
    contributions: [
      { from: contributors.llev, lastUpdated: parseTimestamp("2026-06-22T12:08:58Z") },
    ],
    notes: buildEnsNotSupportedNote({
      method,
      proof: {
        image: at1Proof,
        alt: "Binance doesn't accept ENS names as withdrawal addresses",
      },
    }),
  },
