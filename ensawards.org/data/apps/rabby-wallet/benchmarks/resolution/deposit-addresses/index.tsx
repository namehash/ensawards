...
const depositAddresses = {
  "at01-resolve-onchain-name": {
    ...
    notes: buildPassNoteForAT1({
      ...
      proof: {
        image: at1Proof,
        alt: "Rabby Wallet correctly resolves the address for vitalik.eth",
      },
    }),
  },
  "at02-resolve-name-needing-normalization": {
    ...
    notes: buildPassNoteForAT2({
      ...
      proof: {
        image: at2Proof,
        alt: "Rabby Wallet correctly resolves the address for Ξthereum.eth",
      },
    }),
  },
  "at03-resolve-offchain-eth-subname": {
    ...
    notes: buildPassNoteForAT3({
      ...
      proof: {
        image: at3Proof,
        alt: "Rabby Wallet correctly resolves the address for jesse.base.eth",
      },
    }),
  },
  "at04-resolve-offchain-dns-name": {
    ...
    notes: buildPassNoteForAT4({
      ...
      proof: {
        image: at4Proof,
        alt: "Rabby Wallet correctly resolves the address for dperri.com",
      },
    }),
  },
  "at05-resolve-name-on-other-evm-chain": {
    ...
    notes: buildFailNoteForAT5({
      ...
      proof: {
        image: at5Proof,
        alt: "Rabby Wallet fails to resolve the address for lightkeeper.eth on the Base chain",
      },
