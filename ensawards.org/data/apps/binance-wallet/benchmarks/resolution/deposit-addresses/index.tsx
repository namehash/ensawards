...
const depositAddresses = {
  "at01-resolve-onchain-name": {
    ...
    contributions: [
      { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-19T09:39:20Z") },
    ],
  ...
  "at02-resolve-name-needing-normalization": {
    ...
    contributions: [
      { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-19T09:44:00Z") },
    ],
  ...
  "at03-resolve-offchain-eth-subname": {
    result: BenchmarkResults.NotApplicable,
    contributions: [
      { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-19T09:45:00Z") },
    ],
    notes: buildNotApplicableForFailedTest({ testNumber: 1 }),
  },
  ...
  "at06-resolve-bitcoin-address": {
    result: BenchmarkResults.NotApplicable,
    contributions: [
      { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-19T09:46:00Z") },
    ],
    notes: buildNotApplicableForFailedTest({ testNumber: 1 }),
  },
