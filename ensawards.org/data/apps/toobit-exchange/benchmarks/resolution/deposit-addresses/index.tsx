...
const depositAddresses = {
  "at01-resolve-onchain-name": {
    ...
    contributions: [
      { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-30T11:31:15Z") },
    ],
    notes: buildEnsNotSupportedNote({
      method: 'the "withdraw" flow',
      proof: {
        image: at1Proof,
        alt: "Toobit Exchange doesn't allow ENS names as the recipient in the withdraw flow",
      },
    }),
  },
