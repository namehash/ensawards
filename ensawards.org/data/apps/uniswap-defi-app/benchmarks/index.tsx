...
import UniswapDeFiApp from "data/apps/uniswap-defi-app";
...
const benchmarks: BestPracticeBenchmarks = {
  ...
  "ensv2-ready-resolution": {
    "correctly-resolve-ensv2-test-name-address": {
      ...
      contributions: [
        { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-05T11:00:21Z") },
      ],
      notes: (
        <div className={cn(acceptanceTestDetailsContainerStyles, "w-full")}>
          <p className="w-full">
            ENSv2 ready resolution was tested using the &quot;search&quot; tool. The resolved
            address is correct.
          </p>
          <img
            alt="Uniswap DeFi app correctly resolves the name for ENSv2"
...
defineAppBenchmarks(UniswapDeFiApp, benchmarks);
