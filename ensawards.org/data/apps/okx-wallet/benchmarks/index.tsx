...
import OKXWallet from "data/apps/okx-wallet";
...
const benchmarks: BestPracticeBenchmarks = {
  ...
  "ensv2-ready-resolution": {
    "correctly-resolve-ensv2-test-name-address": {
      ...
      contributions: [
        { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-11T09:22:42Z") },
      ],
      notes: (
        <div className={cn(acceptanceTestDetailsContainerStyles, "w-full")}>
          ...
          <img
            alt="OKX Wallet fails to resolve the name for ENSv2"
...
defineAppBenchmarks(OKXWallet, benchmarks);
