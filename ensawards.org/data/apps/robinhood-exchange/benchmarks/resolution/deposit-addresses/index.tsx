  ...
  "at01-resolve-onchain-name": {
    ...
    notes: buildEnsNotSupportedNote({
      ...
      proof: [
        {
          image: at1Proof1,
          alt: "Robinhood Exchange doesn't allow ENS names as the recipient in the send flow (part 1)",
        },
        {
          image: at1Proof2,
          alt: "Robinhood Exchange doesn't allow ENS names as the recipient in the send flow (part 2)",
        },
      ],
    }),
  },
