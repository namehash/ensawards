...
import KrakenWallet from "data/apps/kraken-wallet";
...
const benchmarks: BestPracticeBenchmarks = {
  ...
  "ensv2-ready-resolution": {
    "correctly-resolve-ensv2-test-name-address": {
      ...
      contributions: [
        { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-10T11:02:00Z") },
      ],
      notes: (
        <div className={cn(acceptanceTestDetailsContainerStyles, "w-full")}>
          ...
          <img
            alt="Kraken Wallet correctly resolves the name for ENSv2"
