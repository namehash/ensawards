...
const depositAddresses = {
  "at01-resolve-onchain-name": {
    ...
    contributions: [
      { from: contributors.y3drk, lastUpdated: parseTimestamp("2026-06-30T13:15:22Z") },
    ],
    notes: buildEnsNotSupportedNote({
      method: 'the "withdrawal" flow',
      proof: {
        image: at1Proof,
        alt: "LBank Exchange doesn't allow ENS names as the recipient in the withdrawal flow",
      },
    }),
  },
